      ...
      <ul className='flex flex-col gap-6 md:max-w-[332px] lg:max-w-none lg:flex-row lg:justify-between'>
        ...
        >
          ...
          <p className='mt-8 text-xs text-light-gray xs:max-w-[80%] md:max-w-none lg:mt-8 lg:text-sm lg:leading-[19px] 1.5xl:max-w-[90%]'>
            Комиссия взимается за каждую эмиссию токена, обеспеченного реальным активом, или за его
            сжигание при выкупе ресурса. Эти сборы создают устойчивую доходную базу и способствуют
        ...
        >
          ...
          <p className='mt-8 text-xs text-light-gray xs:max-w-[80%] md:max-w-none lg:mt-8 lg:text-sm lg:leading-[19px] 1.5xl:max-w-[90%]'>
            ...
            платят небольшую комиссию. Эти смарт-контракты гарантируют выполнение обязательств и
            обеспечивают безопасные транзакции, предоставляя дополнительный доход компании.
          </p>
        </li>
        ...
        >
          ...
          <p className='mt-8 text-xs text-light-gray xs:max-w-[80%] md:max-w-none lg:mt-8 lg:text-sm lg:leading-[19px] 1.5xl:max-w-[90%]'>
            Резервы, хранящиеся для обеспечения токенов, могут быть размещены в безопасных и
            доходных инструментах, таких как облигации или высоконадежные инвестиции. Полученные
